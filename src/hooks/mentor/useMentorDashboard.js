...
import { deleteMentorPost, fetchMyMentorDashboard } from '@/services/mentors/mentorService'
...
export function useMentorDashboard() {
  ...
  // Start delete session post (controller — same role as mentorPostsController)
  const deletePost = useCallback(
    async (postId) => {
      if (!postId || !isApiEnabled()) return { ok: false }
